...
public class WebTabledemo2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"collapsibleNavbar\"]/ul/li[4]/a")).click();
		driver.findElement(By.xpath("/html/body/section/div/div/div[1]/div/div/ul/li[3]/a")).click();
		// WebElement tableName
		// =driver.findElement(By.xpath("//table[@id='example']/tbody/tr[3]/td[1]"));
